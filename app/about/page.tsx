    ...
    >
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              "linear-gradient(#232623 1px, transparent 1px), linear-gradient(90deg, #232623 1px, transparent 1px)",
        ...
        >
          O platformă construită din convingerea că fiecare certificat merită să
          fie autentic, verificabil și accesibil - fără hârtii, fără
          compromisuri.
        </p>
      </section>
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            >
              Într-o lume digitală în care diplomele se pot falsifica ușor,
              Sigillium oferă un strat de autenticitate. Fiecare certificat emis
              prin platforma noastră primește un cod unic și un QR care poate fi
              verificat public, instant, de oricine.
            </p>
          </div>
          ...
          >
            {[
              ...
              >
                ...
                <div
                  style={{ fontSize: 13, color: "#5c5f5a", lineHeight: 1.6 }}
                >
                  {desc}
                </div>
              </div>
      ...
      <section style={{ padding: "100px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            >
              De unde a{" "}
              <em style={{ color: "#c9a84c", fontStyle: "italic" }}>început</em>
            </h2>
          </div>
            ...
            {[
              ...
              >
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: 14, color: "#5c5f5a", lineHeight: 1.7 }}
                  >
                    {text}
                  </div>
                </div>
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            Construit cu tehnologii{" "}
            <em style={{ color: "#c9a84c", fontStyle: "italic" }}>moderne</em>
          </h2>
          <p
            style={{
              fontSize: 15,
          ...
          >
            Stack-ul nostru asigură performanță, securitate și o experiență
            premium.
          </p>
          ...
          <div className="how-grid">
            {[
              {
                name: "Next.js",
                desc: "Framework React full-stack cu server-side rendering și routing avansat.",
                icon: "▲",
              },
              {
                name: "Pupeteer",
                desc: "Transformarea HTML/CSS în PDF-uri de înaltă calitate.",
                icon: "◆",
              },
              {
                name: "PostgreSQL",
                desc: "Bază de date relațională robustă și scalabilă.",
                icon: "⬡",
              },
              {
                name: "Auth.js",
                desc: "Autentificare securizată cu suport pentru roluri multiple.",
                icon: "⊕",
              },
            ].map(({ name, desc, icon }) => (
        ...
        <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            ...
            <div style={{ padding: "40px 32px" }}>
              ...
              >
                Student universitar pasionat de dezvoltare web și securitate
                digitală. Sigillium este rezultatul dorinței de a rezolva o
                problemă reală cu tehnologii moderne.
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          Vrei să afli{" "}
          <em style={{ color: "#c9a84c", fontStyle: "italic" }}>mai mult?</em>
        </h2>
