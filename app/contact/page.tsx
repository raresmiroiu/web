  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hai să vorbim{" "}
          <em style={{ fontStyle: "italic", color: "#c9a84c" }}>împreună</em>
        </h1>
        ...
        >
          Ai o întrebare, o sugestie sau vrei să colaborezi cu noi? Scrie-ne și
          îți răspundem cât mai rapid.
        </p>
      </section>
          ...
          {contactInfo.map(({ label, value, icon }) => (
            ...
            >
              ...
              <div>
                ...
                <div
                  style={{ fontSize: 14, color: "#e8e4db", lineHeight: 1.5 }}
                >
                  {value}
                </div>
              </div>
            ...
            >
              <iframe
                ...
                style={{
                  border: 0,
                  filter:
                    "invert(90%) hue-rotate(180deg) contrast(0.9) brightness(0.7)",
                }}
                allowFullScreen
                loading="lazy"
