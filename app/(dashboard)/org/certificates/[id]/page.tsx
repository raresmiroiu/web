...
export default async function OrgCertificateDetailPage({ params }: Props) {
    ...
    return (
        <div style={{ maxWidth: 600 }}>
            <div style={{ marginBottom: 24 }}>
                <Link href="/org/certificates" style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        background: isValid ? "#3ecf6e" : "#e05c5c",
                    }} />
                ...
                <div style={{ padding: "20px 24px", display: "grid", gap: 16 }}>
                    {[
                        ...
                        <div key={label} style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                            <span style={{ fontSize: 11, color: "#5c5f5a", textTransform: "uppercase", letterSpacing: "0.08em" }}>
                                {label}
                            </span>
                            <span style={{
                                fontSize: 13,
                ...
                <div style={{
                    ...
                    <Link href={`/org/members/${cert.recipient_id}`} style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 12 }}>
                        <div style={{
