      ...
      >
        ...
        <div style={{ padding: "20px 24px", display: "grid", gap: 16 }}>
          {[
            ...
            {
              label: "Data emiterii",
              val: new Date(cert.issued_at).toLocaleDateString("ro-RO", {
                day: "numeric",
                month: "long",
                year: "numeric",
              }),
            ...
            ...(cert.revoked
              ? [
                  {
                    label: "Revocat la",
                    val: new Date(cert.revoked_at).toLocaleDateString("ro-RO", {
                      day: "numeric",
                      month: "long",
                      year: "numeric",
                    }),
        ...
        >
          ...
          <Link
            href={`/org/members/${cert.recipient_id}`}
            style={{
              textDecoration: "none",
              display: "flex",
              alignItems: "center",
          ...
          >
            ...
            >
              {(cert.recipient_name ?? cert.recipient_email)
                .slice(0, 2)
                .toUpperCase()}
            </div>
            <div>
