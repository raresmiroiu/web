			...
			<div className="navbar-actions" style={{ display: "flex", alignItems: "center", gap: 10 }}>
				{isLoggedIn ? (
					<>
						...
						<span style={{ fontSize: 13, color: "#5c5f5a" }}>{name}</span>
						<div style={{
					...
					<>
						...
						<Link href="/contact" style={{ fontSize: 13, color: "#9e9b94", textDecoration: "none" }}>
							Contact
						</Link>
						<Link href="/gallery" style={{ fontSize: 13, color: "#9e9b94", textDecoration: "none" }}>
							Galerie
						</Link>
