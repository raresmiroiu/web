  ...
  return (
    <form action={formAction}>
      ...
      >
        <Link
          href={backLink}
          style={{ color: "#5c5f5a", textDecoration: "none", fontSize: 13 }}
        >
          ← Înapoi
        </Link>
      </div>
      ...
      >
        Editare{" "}
        <em style={{ color: "#c9a84c", fontStyle: "italic" }}>profil</em>
      </h1>
      ...
      {state && (
        <div
          style={{
            fontSize: 13,
            color: state.success ? "#3ecf6e" : "#e05c5c",
            background: state.success
              ? "rgba(62,207,110,0.06)"
              : "rgba(224,92,92,0.06)",
            border: state.success
              ? "1px solid rgba(62,207,110,0.15)"
              : "1px solid rgba(224,92,92,0.15)",
            borderRadius: 6,
            padding: "12px 16px",
            marginBottom: 24,
            display: "flex",
        ...
        >
          <div
            style={{
              ...
              height: 6,
              borderRadius: "50%",
              background: state.success ? "#3ecf6e" : "#e05c5c",
            }}
          />
          {state.message}
        </div>
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: 12, color: "#5c5f5a" }}>{roleLabel}</div>
        </div>
      </div>
