  ...
  return (
    ...
    >
      ...
      >
        ...
        {isValid
          ? "Certificat valid — autentificat de Sigillium"
          : "Certificat revocat — nu mai este valid"}
      </div>
      ...
      <div className="cert-main-info">
        <svg width="32" height="32" viewBox="0 0 40 40" fill="none">
          <path
            ...
            stroke={isValid ? "var(--gold)" : "#e05c5c"}
            strokeWidth="1.5"
            fill="none"
          />
          <circle
      ...
      <div className="verify-meta-grid">
        {[
          ...
          {
            label: cert.revoked ? "Revocat la" : "Domeniu",
            val: cert.revoked ? cert.revokedAt! : cert.domain,
            red: cert.revoked,
          },
