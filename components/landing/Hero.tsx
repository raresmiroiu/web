...
export default function Hero() {
  return (
    ...
    >
      ...
      >
        Certificate{" "}
        <em style={{ fontStyle: "italic", color: "#c9a84c" }}>autentice,</em>
        <strong style={{ fontWeight: 600, display: "block" }}>
          verificabile instant.
        </strong>
      </h1>
      ...
      >
        Emite, gestionează și verifică certificate digitale cu un singur cod.
        Fără hârtii, fără incertitudine.
      </p>
